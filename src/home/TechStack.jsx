  ...
  return (
    <section className="max-w-[1160px] w-full mx-auto mt-[168px] px-[24px] lg:px-0  ">
      ...
      >
        ...
        >
          <h1 className="text-[56px] text-white sm:text-center lg:text-start font-bold leading-[1] mb-3 ">
            Tech Stack
          </h1>
          <p className="text-white sm:text-center lg:text-start leading-[1.8]">
            My tech stack is a strategic blend of advanced tools designed to{" "}
            <span className="font-bold">deliver high-quality</span> ,{" "}
            <span className="font-bold">scalable</span> , and{" "}
            <span className="font-bold">efficient solutions</span> . It’s more
